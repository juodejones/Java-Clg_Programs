...
public class AssociateProfessor extends Employee{
    ...
    public  AssociateProfessor getInstance(String employeeName, String employeeId, String employeeAddress, String employeeEmailID, String mobileNumber, double basicPay){
